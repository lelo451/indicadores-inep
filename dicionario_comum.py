...
# ---------------------------------------------------------------------------
# Tabelas canônicas e utilitários de normalização compartilhados com
# consolidar_indicadores.py. Mantidos aqui para que dicionário e indicadores
# usem exatamente os mesmos rótulos.
# ---------------------------------------------------------------------------
